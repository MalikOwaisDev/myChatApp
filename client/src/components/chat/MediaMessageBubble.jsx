...
const MediaMessageBubble = ({ message, isMine }) => {
  ...
  return (
    <div className={`msg-bubble-wrap${isMine ? ' msg-bubble-wrap--mine' : ''}`}>
      <div className={`msg-bubble msg-bubble--media${isMine ? ' msg-bubble--mine' : ' msg-bubble--theirs'}`}>
        <img src={message.media} alt="Image" className="msg-media__img" />
